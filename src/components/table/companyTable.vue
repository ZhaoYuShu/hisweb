    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button @click="deleteCompanyExamRecord(scope.row)" type="text" size="small">删除</el-button>
          <el-button type="text" size="small" @click="updateForm(scope.row)">修改</el-button>
        </template>
      </el-table-column>
    </el-table>
