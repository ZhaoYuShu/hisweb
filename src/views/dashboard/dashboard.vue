<template>
  <div class="app-container">
   <!--<nx-github-corner></nx-github-corner>-->
    ...
    <el-row>
      <el-col>
        <h4 class="title">欢迎使用&nbsp;&nbsp;体检管理系统V1.0</h4>
      </el-col>
    </el-row>
    <div class="item">
      <h4>个人体检</h4>
      <ul>
        <li v-for="item in list1" class="listItem">
    ...
    <div class="item">
      <h4>单位体检</h4>
      <ul>
        <li v-for="item in list2" class="listItem">
          <router-link :to="item.path">{{item.value}}</router-link>
        </li>
        <div class="clear" style="clear:both;"></div>
      </ul>
    ...
    <div class="item">
      <h4>体检诊台</h4>
      <ul>
        <li v-for="item in list3" class="listItem">
          <router-link :to="item.path">{{item.value}}</router-link>
        </li>
        <div class="clear" style="clear:both;"></div>
      </ul>
...
export default {
  ...
  data() {
    return {
      ...
      // }
      list1: [
        {id: 0, value: '个人体检登记', path: '/exam/registration'},
        {id: 1, value: '个人体检收费', path: '/exam/examFee'},
        {id: 2, value: '打印指引单', path: '/exam/instructionSheet'}
      ],
      list2: [
        {id: 0, value: '体检单位登记', path: '/exam/company'},
        {id: 1, value: '单位分组设置', path: '/exam/companyGroup'},
        {id: 2, value: '预登记', path: '/exam/individualPreRegistration'},
        {id: 3, value: '正式登记', path: '/exam/officiallyRegistered'},
        {id: 4, value: '单位收费', path: '/exam/companyFee'}
      ],
      list3: [
        {id: 0, value: '体检医生诊台', path: '/exam/physicalExamination'},
        {id: 1, value: '检验项目诊台', path: '/exam/inspection'},
        {id: 2, value: '总检医生诊台', path: '/exam/generalExamination'}
      ]
    }
  },
  created() {},
...
<style scoped>
  ...
  .listItem{
    ...
    color:rgb(66, 185, 131);
    transition: font-size  1s ease, box-shadow 1s ease;
  }
  .listItem:hover{
    font-size:18px;
